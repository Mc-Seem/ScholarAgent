...
### Current Semantic/KG Verification (2026-08-02)
...
- `465` frontend tests pass, including click/keyboard-only annotations, Equation Lens selection, sidebar/back/split behavior, glossary, schema-v3 graph details, workspace caches, and shared Theia selections.
